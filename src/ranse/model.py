...
Deliberately *outside* core (PLAN.md §2): these types carry timetable / e-RPH
...
def merge_periods(day_schedule: Dict[int, Lesson]) -> List[Tuple[int, Lesson]]:
    ...
    A gap in time ends a run even when the lesson repeats (PLAN.md risk 4).
    """
...
@dataclass
class Profile:
    """A loaded profile file (PLAN.md §3: explicit handler list)."""
